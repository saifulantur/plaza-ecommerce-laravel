...
<html lang="zxx">
    ...
    <body>
        ...
        <!-- Header section -->
        <header class="header-section @yield('header_class')">
            <div class="container-fluid">
                ...
                <div class="header-right">
                    <a href="cart.html" class="card-bag"><img src="{{ asset('frontend_assets/img/icons/bag.png') }}"
                        alt=""><span>2</span></a>
                    ...
                    <ul class="main-menu">
                        @php
                            ...
                            $menus = App\Category::where('menuStatus', '=', 1)->get();

                        @endphp 
                        <li><a href="{{ url('/') }}">Home</a></li>
                        @foreach($menus as $menu)
                        <li><a href="{{ url('category/wise/product') }}/{{ $menu->id }}">{{$menu->categoryName}}</a></li>
                        @endforeach
